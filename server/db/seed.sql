...
-- Sample problems
INSERT INTO questions (display_index, title, description, input_format, output_format, sample_input, sample_output, difficulty, time_limit, memory_limit, is_visible) VALUES
(0, 'A+B Problem', '给定两个整数 a 和 b，输出 a+b 的结果。', '一行，包含两个整数 a 和 b，以空格分隔。', '一个整数，表示 a+b 的结果。', '1 2', '3', '简单', 1, 256, 1),
(1, '最大子数组和', '给定一个整数数组，找到和最大的连续子数组，并返回其最大和。', '第一行一个整数 n，表示数组长度。第二行 n 个整数，以空格分隔。', '一个整数，表示最大子数组和。', '9\n-2 1 -3 4 -1 2 1 -5 4', '6', '中等', 1, 256, 1);
