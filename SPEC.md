...
> **代码持久化**：每个题目的代码自动保存到浏览器 `localStorage`（键 `code_{题目ID}`）。切换题目或返回时自动恢复，提交后不清除。
...
│  用户名: alice                              │
│                                            │
│  共 5 次提交，通过 2 题，尝试 3 题           │
│                                            │
│  【我的提交】                               │
│  题目          状态     耗时/内存       时间                 │
│  A+B Problem    AC      15ms/2560KB   2026-01-15 10:20    │
│  A+B Problem    WA      12ms/2048KB   2026-01-15 10:15    │
│  最大子数组和    TLE     1200ms/512KB  2026-01-15 09:50    │
│                                            │
│  [加载更多]                                 │
└────────────────────────────────────────────┘
```
